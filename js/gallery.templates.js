...
templates['gallery-categories-template.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\"nav-item\">\n  <a\n    class=\"nav-link active ps-0 disabled\"\n    href=\"#\"\n    onclick=\"loadData('gallery', 'gallery-template', 'gallery'); disableLink(this);\"\n  >Show all</a>\n</li>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"data") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":8,"column":0},"end":{"line":16,"column":9}}})) != null ? stack1 : "");
},"useData":true});
